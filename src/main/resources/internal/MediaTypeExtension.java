...
import org.openhab.io.graphql.GQLService;
...
@JaxrsApplicationSelect("(" + JaxrsWhiteboardConstants.JAX_RS_NAME + "=" + GQLService.REST_APP_NAME + ")")
@JaxrsExtension
...
public class MediaTypeExtension<T> implements MessageBodyReader<T>, MessageBodyWriter<T> {
    ...
    public boolean isWriteable(final Class<?> type, final Type genericType, final Annotation[] annotations,
        ...
        System.out.println("Considering " + mediaType + " = " + type.getName() + "," + genericType.getTypeName());
